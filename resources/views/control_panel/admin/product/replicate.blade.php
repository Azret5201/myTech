...
@section('content')
    <div class="container-xl">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('cp.admin.product.store', $product->id) }}" method="post" class="ajax row">
                    <div class="col-md-6">
                        <fieldset>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col-12 form-control" id="text_blocks.editor">
                                ...
                                <select class="select2-multiple form-control" name="shouldUser[]" multiple="multiple"
                                    ...
                                    @foreach($properties as $property)
                                        <option value="{{ $property->name }}"
                                                @isset($productProperties)
                                                @foreach($productProperties as $productProperty)
                                                @if($productProperty->propName->name == $property->name && $productProperty->should_user_fill == 1) selected @endif
                                            @endforeach
                                            @endisset
...
@push('scripts')
    ...
    <script>
        ...
        $('#addProperty').click(function () {
            ...
            document.querySelector('input[name="prop[' + index + '][propName]"]').focus();
        ...
        $(".preview-images-zone").sortable({
            stop: function (event, ui) {
                ...
                console.log(event.target, ui.item.find('.order').val());
            }
        });
