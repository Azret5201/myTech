    ...
    <div class="container-xl">
        ...
        <div class="card">
            ...
            <div class="card-body row row-cards">
                <div class="col-lg-12">
                    <form action="{{ route('cp.admin.category.store') }}" method="post" class="ajax">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control" name="parent_id" id="parent_id">
                                ...
                                @foreach($categories as $categoryAsOption)
                                    <option
                                        value="{{ $categoryAsOption->id }}">{{ str_repeat('- ', $categoryAsOption->depth) }}{{ $categoryAsOption->name }}</option>
                                @endforeach
                            </select>
                            <div class="invalid-feedback"></div>
                        </div>
