    ...
    <div class="header-top">
        <div class="container">
            ...
            <div class="header-right">
                ...
                <div class="dropdown">
                    <a href="#language"><img src="{{ asset('/vendor/wolmart/images/flags/eng.png') }}" alt="ENG Flag" width="14"
                                             height="8" class="dropdown-image" /> ENG</a>
                    <div class="dropdown-box">
                        <a href="#ENG">
                            <img src="{{ asset('/vendor/wolmart/images/flags/eng.png') }}" alt="ENG Flag" width="14" height="8"
                                 class="dropdown-image" />
                            ENG
                        </a>
                        <a href="#FRA">
                            <img src="{{ asset('/vendor/wolmart/images/flags/fra.png') }}" alt="FRA Flag" width="14" height="8"
                                 class="dropdown-image" />
                            FRA
                        </a>
                    </div>
                ...
                @if(!auth()->user())
                <a href="{{ route('cp.client.auth.login.get') }}" class=""><i
                        class="w-icon-account"></i>Войти</a>
                <span class="delimiter d-lg-show">/</span>
                    <a href="{{ route('cp.client.auth.register.get') }}" class="ml-0  ">Регистрация</a>
                @else
                    <a href="{{ route('profile') }}" class="d-lg-show">Профиль</a>
                    <a onclick="document.getElementById('logout-form-auth').submit();" class="logout">Выйти</a>
    ...
    <div class="header-middle">
        <div class="container">
            <div class="header-left mr-md-4">
                ...
                <a href="{{ route('main') }}" class="logo ml-lg-0">
                    <img src="{{ asset('/vendor/wolmart/images/demos/demo7/header-logo.png') }}" alt="logo" width="144" height="45" />
                </a>
            ...
            <div class="header-right ml-4">
                ...
                <div class="dropdown cart-dropdown cart-offcanvas mr-0 mr-lg-2">
                    ...
                    <a href="{{ route('cart') }}" class="cart-shop">
                        <i class="w-icon-cart">
                                    ...
                                    <ul class="megamenu">
                                        ...
                                        <li>
                                            <div class="banner-fixed menu-banner menu-banner2">
                                                <figure>
                                                    <img src="{{ asset('/vendor/wolmart/images/menu/banner-2.jpg') }}" alt="Menu Banner"
                                    ...
                                    <ul class="megamenu">
                                        ...
                                        <li>
                                            <div class="menu-banner banner-fixed menu-banner3">
                                                <figure>
                                                    <img src="{{ asset('/vendor/wolmart/images/menu/banner-3.jpg') }}" alt="Menu Banner"
                                    ...
                                    <ul class="megamenu">
                                        ...
                                        <li>
                                            <div class="menu-banner banner-fixed menu-banner4">
                                                <figure>
                                                    <img src="{{ asset('/vendor/wolmart/images/menu/banner-4.jpg') }}" alt="Menu Banner"
                                        ...
                                        <li class="row">
                                            <div class="col-6">
                                                <div class="banner banner-fixed menu-banner5 br-xs">
                                                    <figure>
                                                        <img src="{{ asset('/vendor/wolmart/images/menu/banner-5.jpg') }}" alt="Banner"
                                            ...
                                            <div class="col-6">
                                                <div class="banner banner-fixed menu-banner5 br-xs">
                                                    <figure>
                                                        <img src="{{ asset('/vendor/wolmart/images/menu/banner-6.jpg') }}" alt="Banner"
                                                             width="410" height="123"
