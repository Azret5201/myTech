            ...
            <div class="row justify-content-center align-items-center">
                ...
                <div class="col-xl-7 col-lg-6 col-md-9 mt-4 mt-lg-0 ">
                    <form action="#" method="get"
                        ...
                        <input type="email" class="form-control mr-2 bg-white" name="email" id="email23"
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="widget widget-about mt-0">
                        <a href="demo7.html" class="logo-footer">
                            <img src="{{ asset('/vendor/wolmart/images/demos/demo7/footer-logo.png') }}" alt="logo-footer" width="145"
                                 height="45" />
                        </a>
        ...
        <div class="footer-bottom">
            ...
            <div class="footer-right">
                ...
                <figure class="payment">
                    <img src="{{ asset('/vendor/wolmart/images/payment.png') }}" alt="payment" width="159" height="25" />
                </figure>
            </div>
        </div>
    </div>
